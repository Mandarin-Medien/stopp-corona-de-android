...
import de.schwerin.stoppCoronaDE.screens.dashboard.startDashboardActivity
...
class RouterActivity : FragmentActivity(), KoinComponent {
    ...
    private val skipSplashscreenDelay: Boolean by argument(ARGUMENT_SKIP_SPLASHSCREEN_DELAY, true)
