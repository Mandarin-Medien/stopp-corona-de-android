...
import de.schwerin.stoppCoronaDE.constants.Constants.Nearby.IDENTIFICATION_BYTE_LENGTH
import de.schwerin.stoppCoronaDE.constants.Constants.Nearby.PUBLIC_KEY_LOOKUP_THRESHOLD_MINUTES
...
class NearbyRepositoryImpl(
    ...
    override val messageListener: MessageListener = object : MessageListener() {
        ...
        override fun onFound(message: Message?) {
            ...
            Timber.e("Found" + message.toString())
