package de.schwerin.stoppCoronaDE.model.repositories.other
...
import de.schwerin.stoppCoronaDE.constants.Constants.Behavior.OFFLINE_SYNC_INTERVAL
import de.schwerin.stoppCoronaDE.constants.Constants.Prefs.OFFLINE_SYNC_PREFIX
import de.schwerin.stoppCoronaDE.model.api.ApiError
import de.schwerin.stoppCoronaDE.model.exceptions.DataFetchFailedException
import de.schwerin.stoppCoronaDE.model.exceptions.DataPopulationFailedException
...
import de.schwerin.stoppCoronaDE.screens.routing.RouterActivity
...
class OfflineSyncerImpl(
    ...
    private inner class LifecycleListener : LifecycleObserver {
        ...
        fun onEnterForeground() {
            ...
            println("onEnterForegroundCOROAN")
